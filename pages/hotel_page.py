...
class HotelPage(SeleniumDriver):
    ...
    _checkin_date="//button[@data-day='14' and @data-month='7']"
    _checkout_tab="//input[@id='hotel-checkout-hp-hotel']"
    _checkout_date="//*[@id='hotel-checkout-wrapper-hp-hotel']/div/div/div[3]/table/tbody/tr[5]/td[5]/button"
    ...
    _select_hotel=" //a[contains(text(),'Click for more information about Shelburne Hotel &')]"
...
###################
    ...
    def addroom(self):
        self.click_addroom()
        time.sleep(2)
    def clickchildadd(self):
        self.click_childadd()
        time.sleep(2)
    # def clickchildagebutton(self):
